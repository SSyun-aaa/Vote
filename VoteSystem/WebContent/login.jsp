...
<body id="login">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="login.html">ログイン<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="newuser.html">新規登録</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <form action="#" name="loginform" method="post" onsubmit="return check()">
        ...
        <p>新規登録の方は<a href="newuser.html">コチラ</a></p>
