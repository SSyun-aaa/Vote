	...
	<div class="container">
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<h1>コンテンツ詳細登録</h1>
				<form name="check" action="InsertContentsdata" method="post" onsubmit="return check()">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="name" id="contentsName" placeholder="コンテンツ詳細名">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
    					...
    					<textarea class="form-control" id="textarea" name="intro" rows="3"></textarea>
  					</div>
					<div class="form-group">
